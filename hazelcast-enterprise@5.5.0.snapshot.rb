class HazelcastEnterpriseAT550Snapshot < Formula
    ...
    url "https://repository.hazelcast.com/snapshot/com/hazelcast/hazelcast-enterprise-distribution/5.5.0-SNAPSHOT/hazelcast-enterprise-distribution-5.5.0-20240521.100621-395.tar.gz"
    sha256 "54f3de99a01e329287db81d0e2b08ecb6015539f80200f24fde432af2064ad26"
    ...
    conflicts_with "hazelcast@5.3.8.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast@5.3.7.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast@5.3.6.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast@5.3.1.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast@5.2.6.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast@5.2.5.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast@5.2.4.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast@5.1.7.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
