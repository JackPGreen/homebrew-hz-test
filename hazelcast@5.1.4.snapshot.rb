class HazelcastAT514Snapshot < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://oss.sonatype.org/content/repositories/snapshots/com/hazelcast/hazelcast-distribution/5.1.4-SNAPSHOT/hazelcast-distribution-5.1.4-20220803.073933-2.tar.gz"
    sha256 "4282a3a03988b7a35b5b2e67cf34c4a9b1259370b30c9b0879b31d2e3b4570d2"
