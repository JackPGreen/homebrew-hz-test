class HazelcastAT504Snapshot < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://oss.sonatype.org/content/repositories/snapshots/com/hazelcast/hazelcast-distribution/5.0.4-SNAPSHOT/hazelcast-distribution-5.0.4-20220802.094650-28.tar.gz"
    sha256 "e21d977d7cd1b3e2a1cab92d8a1e502eeae44f60d80f7e4f0f17ad5ba9995bbe"
